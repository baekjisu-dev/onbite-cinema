  ...
  return (
    <div className={style.container}>
      <div
        ...
        style={{ backgroundImage: `url(${mockData.posterImgUrl})` }}
      >
        <img src={mockData.posterImgUrl} alt={mockData.title} />
      </div>
      <div className={style.movie_info_container}>
        <p className={style.movie_title}>{mockData.title}</p>
        <p className={style.sub_text}>
          {mockData.releaseDate} / {mockData.genres.join(", ")} /{" "}
          {mockData.runtime}분
        </p>
        <p className={style.sub_text}>{mockData.company}</p>
        <p className={style.sub_title}>{mockData.subTitle}</p>
